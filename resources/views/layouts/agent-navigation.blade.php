        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('agent.moneyCollection', ['id' => Auth::user()->id])" :active="request()->routeIs('agent.moneyCollection')">
                        {{ __('Money Collection') }}
                    </x-nav-link>

                    <x-nav-link :href="route('agent.moneySent')" :active="request()->routeIs('agent.moneySent')">
