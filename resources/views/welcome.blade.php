    ...
    <head>
        ...
        <style>
            ...
            .headerStyle {
                ...
                color: #fff!important; /* Text color without opacity */
                font-style: bold;
                z-index: 1000;
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-4">
                        <div class="grid gap-4 lg:grid-cols-2 lg:gap-8">
                            <div class="p-6 bg-white rounded-lg shadow-[0px 14px 34px 0px rgba(0,0,0,0.08)] dark:bg-zinc-900 dark:shadow-[0px 4px 34px rgba(0,0,0,0.06)]">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Welcome to {{ config('app.name', 'Laravel') }}</h2>
                                <p class="mt-4 text-sm text-black dark:text-white/70">
