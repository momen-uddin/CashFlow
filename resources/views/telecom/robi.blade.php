<x-app-layout>
    <x-slot name="header">
        <div class=" d-flex align-items-center ">
            ...
            <button type="button" class="btn btn-sm bg-[#f84e4e] hover:bg-[#973737] mb-2 text-light" data-bs-toggle="modal"
...
<x-i_modal title="Add Package" id="addPack">
    ...
    <form action="{{ route('addRobi') }}" method="POST">
        @csrf
        ...
        <div class="mt-2">
            <input type="submit" value="Insert"
                class="btn btn-sm bg-[#f84e4e] hover:bg-[#973737] mt-1 mb-1 float-end text-light">
        </div>
    </form>
