<x-app-layout>
    <x-slot name="header">
        <div class=" d-flex align-items-center ">
            ...
            <button type="button" class="btn btn-sm btn-dark bg-[#bc569f] hover:bg-[#ff0000] mb-2" data-bs-toggle="modal"
                        ...
                        <tbody>
                            ...
                            @foreach ($airtel as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('deleteAirtel', ['id' => $data->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
...
<x-i_modal title="Add Package" id="addPack">
    ...
    <form action="{{ route('addAirtel') }}" method="POST">
        @csrf
        ...
        <div class="mt-2">
            ...
            <select
                ...
                aria-label="Default select example" name="packName">
