<x-app-layout>
    <x-slot name="header">
        <div class=" d-flex align-items-center ">
            ...
            <button type="button" class="btn btn-sm bg-[#0f5fa6] hover:bg-[#1b5390] mb-2 text-light" data-bs-toggle="modal"
                        ...
                        <tbody>
                            ...
                            @foreach ($grameen as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('deleteGrameen', ['id' => $data->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
...
<x-i_modal title="Add Package" id="addPack">
    ...
    <form action="{{ route('addGrameen') }}" method="POST">
        @csrf
        ...
        <div class="mt-2">
            <input type="submit" value="Insert"
                class="btn btn-sm bg-[#0f5fa6] hover:bg-[#1b5390] mt-1 mb-1 float-end text-light">
        </div>
    </form>
